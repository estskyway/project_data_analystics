...
- 아래 그림은 pyLDAvis를 통해 시각화한 자료입니다.
  ...
  |💔부정적 평점의 리뷰 토픽 모델링 시각화 결과 [(링크)]([https://github.com/estskyway/project_data_analystics/datasets/visualization_negative.html](https://estskyway.github.io/project_data_analystics/datasets/visualization_negative.html))|
  |:---:|
